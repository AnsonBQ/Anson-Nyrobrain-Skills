---
name: deepapi
description: DeepAPI is the API for web search, deep research, web scraping (websites, LinkedIn, GitHub, X/Twitter, YouTube, Instagram), browser automation, email, and image generation. Activate this skill ONLY when the user explicitly calls /deepapi or mentions DeepAPI in the prompt. Do not auto-activate for generic search, research, or scraping tasks — use built-in tools for those.
metadata:
...
| An endpoint this table does not list | — | `local-api-reference.md` — the full 83-endpoint reference, incl. GitHub repo/contents/issues, Amazon, Instagram |
